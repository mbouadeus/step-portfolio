...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeesCannotFit() {
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void optionalAttendeesCanFit() {
    // Events  :       |--A--|     |--B--|
    // Optional:             |-C-|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--2--|
  ...
  @Test
  public void noRoomForOptionalAttendees() {
    // Events  : |--A--|     |----A----|
    // Optional:       |-B-|
    // Day     : |---------------------|
    // Options :       |--1--|
  ...
  @Test
  public void optionalAttendeesOnlyWithoutRoom() {
    // Optional: |-----A-----||--------B-------|
    // Day     : |-----------------------------|
    // Options : 
    ...
    Collection<Event> events = Arrays.asList(
      new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_1100AM, false),
        Arrays.asList(PERSON_A)),
      new Event("Event 2", TimeRange.fromStartDuration(TIME_1100AM, TimeRange.END_OF_DAY),
        Arrays.asList(PERSON_B)));
